...
import toastifySuccess from "../services/utilService";
...
const AddNewRoom = (props) => {
  ...
  function handleSave() {
    ...
    httpService
      .post(process.env.REACT_APP_rgsevaUrl + "/test/save", formParams)
      .then((response) => {
        // console.log(response.data);
        toastifySuccess("Saved Successfully");
  ...
  return (
    <>
      ...
      <h5 className="text-center">Add New Room </h5>
              ...
              <tr>
                ...
                <td className="text-start ps-2">
                  <input
                    ...
                    value={formParams.roomCountTotal}
                    className=" form-control"
          ...
          <div className="mb-4">
            <div className="hstack gap-3 mt-2">
              <button
                ...
                onClick={() => navigate("/admin/roomList")}
                style={{ width: "100px" }}
              >
                Back
              </button>
